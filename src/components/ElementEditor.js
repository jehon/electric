...
(function() {
  ...
  class ElementEditor extends InstallationAbstract {
    connectedCallback() {
    ...
    render() {
      ...
      this.querySelector("[name='name']").addEventListener('change', () => this.nameChanged());

      this.querySelector("[name='plan']").addEventListener('change', () => this.planChanged());
      this.querySelectorAll("[name^='plan_']").forEach(el => el.addEventListener('change', () => this.positionChanged()));
    }
    ...
    adapt() {
      ...
      // Positions
      this.querySelector("[name='plan']").innerHTML = '<option value="">Seulement dans le coffret</option>'
      ...
      positionAdapt() {
        if (this.currentElement.plan) {
          ...
          this.querySelectorAll("[name^='plan_']").forEach(el => el.removeAttribute("disabled"));
          ...
          this.querySelectorAll("[name^='plan_']").forEach(el => el.setAttribute("disabled", true));
        }
      }

      getMainElement() {
        return document.querySelector("installation-filiaire, installation-position");
      }

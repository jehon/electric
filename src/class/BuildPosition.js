...
import away from "../helpers/away.js";

export default class BuildPosition extends BuildName {
  ...
  buildSelf() {
    ...
    let svg = `<g type='translate' transform='translate(${this._currentElement.getVal("x")}, ${this._currentElement.getVal("y")})'>
  ...
  rotatedLabel() {
    let label =
      "getName" in this._currentElement ? this._currentElement.getName() : "";
    if (!label) {
      return "";
    }
